...
namespace ServerConfig
{
    ...
    SERVER_CFG_PREFIX BoolServerConfigParam m_save_goals
	...
	SERVER_CFG_PREFIX StringServerConfigParam m_race_tournament_players
		SERVER_CFG_DEFAULT(StringServerConfigParam("",
			"race-tournament-players",
			"List of players and judges. Use the format \"P player player "
    ...
    SERVER_CFG_PREFIX StringServerConfigParam m_gnu2_available_tracks
		...
		" If this is empty, all tracks are available which all participants have."));

	SERVER_CFG_PREFIX BoolServerConfigParam m_gnu2_random_tracks
		SERVER_CFG_DEFAULT(BoolServerConfigParam(true, 
		"gnu2-random-tracks",
